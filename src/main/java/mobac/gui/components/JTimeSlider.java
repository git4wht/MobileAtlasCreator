...
public class JTimeSlider extends JSlider {
	...
	static {
		...
		LABEL_TABLE.put(MIN, new JLabel("0 sec"));
		LABEL_TABLE.put(hour, new JLabel("1 hour"));
		LABEL_TABLE.put(day, new JLabel("1 day"));
		LABEL_TABLE.put(month, new JLabel("1 month"));
		LABEL_TABLE.put(year, new JLabel("1 year"));
		LABEL_TABLE.put(MAX, new JLabel("never"));
	}
