...
public class MainGUI extends JFrame implements MapEventListener {
	...
	private void createControls() {
		...
		mapSourceTree.addMouseMotionListener(new MouseMotionAdapter() {
			...
			public void mouseMoved(MouseEvent e) {
				...
				jTree.setCursor(isLocationClickable ? Cursor.getPredefinedCursor(Cursor.HAND_CURSOR)
	...
	private void loadSettings() {
		...
		Set<String> trustedCertificatesLowerCase = new HashSet<>();
		for (String hash : settings.trustedCertificates) {
			trustedCertificatesLowerCase.add(hash.toLowerCase());
		}
		settings.trustedCertificates.clear();
		settings.trustedCertificates.addAll(trustedCertificatesLowerCase);
