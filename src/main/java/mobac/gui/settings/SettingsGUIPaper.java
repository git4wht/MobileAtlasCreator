...
public class SettingsGUIPaper extends JPanel {
	...
	private final JComboBox<Format> jComboBoxFormat = new JComboBox<>(Format.values());
	private final JComboBox<WgsDensity> jComboBoxWgsDensity = new JComboBox<>(WgsDensity.values());
	...
	private final SpinnerNumberModel modelCrop = new SpinnerNumberModel(SettingsPaperAtlas.CROP_DEFAULT,
			SettingsPaperAtlas.CROP_MIN, SettingsPaperAtlas.CROP_MAX, 1),
			modelDpi = new SpinnerNumberModel(SettingsPaperAtlas.DPI_DEFAULT, SettingsPaperAtlas.DPI_MIN,
