...
public class SettingsGUI extends JDialog {
	...
	private static final Integer[] THREADCOUNT_LIST = { 1, 2, 4, 8, 12, 16, 50, 100, 200, 400 };
	...
	private class MapPacksOnlineUpdateAction implements ActionListener {
		...
		public void actionPerformed(ActionEvent event) {
			...
			try {
				...
				default:
					JOptionPane.showMessageDialog(SettingsGUI.this,
							String.format(I18nUtils.localizedStringForKey("set_mapsrc_config_online_update_msg_done"),
									result),
