...
import mobac.program.atlascreators.MaverickOld;
...
import mobac.program.atlascreators.TMSTiles;
import mobac.program.atlascreators.TMSTilesZip;
import mobac.program.atlascreators.TTQV;
import mobac.program.atlascreators.TileStoreDownload;
import mobac.program.atlascreators.TileStoreDump;
import mobac.program.atlascreators.TileStoreExport;
...
public class AtlasOutputFormat implements Comparable<AtlasOutputFormat> {
	...
	static {
		...
		FORMATS.add(createByClass(MaverickOld.class));
		...
		FORMATS.add(createByClass(TMSTiles.class));                 // CUSTOM WHT
		FORMATS.add(createByClass(TMSTilesZip.class));              // CUSTOM WHT
		FORMATS.add(createByClass(TileStoreDump.class));            // CUSTOM WHT
		FORMATS.add(createByClass(TileStoreExport.class));          // CUSTOM WHT
