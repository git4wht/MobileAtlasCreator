...
public class Settings {
	...
	/**
	 * List of trusted certificates (hex encoded lowercase SHA256 hash of the certificate)
	 */
	@XmlElementWrapper(name = "trustedCertificates")
	@XmlElement(name = "certificateHash")
	public final Set<String> trustedCertificates = new HashSet<>();
